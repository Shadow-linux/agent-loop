...
13a. During Quick Onboarding, produce only a shallow, evidence-labeled safe-continuation snapshot: `project.md`, base folders, root guidance proposal/status, and uncertainties. Do not create onboarding-db files or diagrams unless Deep Project Onboarding Scan or Targeted Onboarding Scan is explicitly selected and confirmed. Refresh or upgrade Quick output when it is stale, incomplete, or insufficient for the requested work.
