...
require_text "references/onboarding-knowledge-base.md" "计划确认后 Agent 可以全盘执行"
...
require_text "references/stage-guides.md" "计划确认后 Agent 可以全盘执行"
...
require_text "templates/onboarding-db/onboarding-spec.md" "计划确认后 Agent 可以全盘执行"
