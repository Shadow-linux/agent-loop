...
require_text "references/onboarding-knowledge-base.md" "## Core Flow Inventory"
require_text "references/onboarding-knowledge-base.md" "## Flow Slice Coverage"
require_text "references/onboarding-knowledge-base.md" "## Core Flow Diagram Set"
require_text "references/onboarding-knowledge-base.md" "## Complexity-Triggered Diagrams"
require_text "references/onboarding-knowledge-base.md" "## Completeness Hard Gate"
require_text "references/onboarding-knowledge-base.md" "content-bearing onboarding-db document"
require_text "references/onboarding-knowledge-base.md" "must use diagrams that explain real semantics"
...
require_text "references/onboarding-knowledge-base.md" "primary per-flow narrative"
require_text "references/onboarding-knowledge-base.md" "stateless topics do not require state diagrams"
require_text "references/onboarding-knowledge-base.md" "missing critical slice cannot be averaged away"
...
require_text "references/stage-guides.md" "Flow Slice Coverage"
require_text "references/stage-guides.md" "Completeness Hard Gate"
...
require_text "references/workflow-checklists.md" "Core Flow Inventory"
require_text "references/workflow-checklists.md" "Flow Slice Coverage"
require_text "references/workflow-checklists.md" "Complexity-triggered diagrams"
require_text "references/workflow-checklists.md" "Completeness Hard Gate"
require_text "references/workflow-checklists.md" "stateless glossary"
...
require_text "templates/onboarding-db/module.md" "Timeline / 时序图（有顺序或数据移动时必填）"
...
require_text "templates/onboarding-db/onboarding-spec.md" "## Core Flow Selection"
require_text "templates/onboarding-db/onboarding-spec.md" "## Flow Slice Plan"
require_text "templates/onboarding-db/onboarding-spec.md" 'Every planned `critical` / `important` flow doc must have Required Architecture/Boundary Diagram'
...
require_text "templates/onboarding-db/onboarding-tasks.md" "Required Slice IDs"
require_text "templates/onboarding-db/onboarding-tasks.md" "Completeness Hard Gate"
require_text "templates/onboarding-db/onboarding-tasks.md" "Mermaid flowchart / sequenceDiagram"
require_text "templates/onboarding-db/README.md" "Core Flow Overview / Boundary"
require_text "templates/onboarding-db/README.md" "stateless glossary"
...
require_text "templates/onboarding-db/coverage-matrix.md" "Completeness Hard Gate"
require_text "templates/onboarding-db/coverage-matrix.md" "Core flow discovery completeness"
require_text "templates/onboarding-db/coverage-matrix.md" "Slice and branch coverage"
...
require_text "templates/onboarding-db/batch-review.md" "Completeness Hard Gate"
