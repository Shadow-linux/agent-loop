...
assert_contains templates/spec.md 'Freshness: current | refresh-required | blocked'
...
assert_contains references/runtime.md 'Auto Mode cannot continue'
...
assert_contains references/document-templates.md 'Freshness: current | refresh-required | blocked'
