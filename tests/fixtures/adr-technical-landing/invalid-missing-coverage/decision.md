# ADR-9001: Missing Coverage Fixture
...
|---|---|---|---|---|---|---|
| REL-FIXTURE-LINK | source relationship reference | landed | generic boundary | relationship invariant | DS-FIXTURE-REL | verification target |
