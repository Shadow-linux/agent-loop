...
assert_contains "$tmpdir/stale.out" "expected 1.4.0-20260716"
...
awk '
  /<!-- agent-loop:managed-start section:ownership/ && inserted != 1 {
    print
    print "<!-- agent-loop:managed-start section:nested source:.agent-loop/project.md block-version:1.4.0-20260716 -->"
    print "nested"
...
awk '
  ...
  /<!-- agent-loop:managed-end section:ownership -->/ && inserted != 1 {
    print "<!-- agent-loop:managed-start section:ownership source:.agent-loop/project.md block-version:1.4.0-20260716 -->"
    print "duplicate"
...
{
  cat "$template"
  printf '\n<!-- agent-loop:managed-start section:legacy-extra source:.agent-loop/project.md block-version:1.4.0-20260716 -->\n'
  printf '## Legacy Extra\n\n'
...
{
  cat "$template"
  printf '\n<!-- agent-loop:managed-start section:same-line source:.agent-loop/project.md block-version:1.4.0-20260716 --><!-- agent-loop:managed-end section:same-line -->\n'
} > "$tmpdir/same-line.md"
