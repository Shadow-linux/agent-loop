...
assert_contains references/external-skill-adapters.md 'does not authorize Product Human Review, ADR acceptance, Feature start, Git, release, publish, seal, or future external actions'
