...
assert_file_exists "templates/onboarding-db/star-deep-dive.md"
...
assert_contains "templates/onboarding-db/onboarding-spec.md" "## Required-Core Topic Budget"
assert_contains "templates/onboarding-db/onboarding-plan.md" "## File Budget And Split Gate"
assert_contains "templates/onboarding-db/star-deep-dive.md" "## Phase-By-Phase Deep Dive"
assert_contains "templates/onboarding-db/star-deep-dive.md" "## Code Evidence And Symbols"
assert_contains "templates/onboarding-db/star-deep-dive.md" "## Failure / Retry / Idempotency / Compensation"
assert_contains "templates/onboarding-db/coverage-matrix.md" "newcomer-ready requires an accepted star doc"
