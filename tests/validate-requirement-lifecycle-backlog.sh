...
assert_contains "SKILL.md" "Version: 1.4.0"
assert_contains "README.md" "**Current version:** 1.4.0"
assert_contains "Usage.md" "**版本：** 1.4.0"
assert_contains "plugin.json" '"version": "1.4.0"'
assert_contains "templates/root-AGENTS.md" "block-version:1.4.0-20260715"
assert_contains "CHANGELOG.md" "## 1.4.0 — 2026-07-15"
assert_contains "CHANGELOG.md" "block-version:1.4.0-20260715"
