...
assert_contains "Usage.md" "1.5.5 更新了什么？"
assert_contains "Usage.md" "当前 1.5.5 使用的是"
...
assert_contains "README.md" "**Current version:** 1.5.5 (stable)"
assert_contains "README.md" 'stable tag is `stable-v1.5.5`'
assert_contains "README.md" "--branch stable-v1.5.5"
assert_contains "Usage.md" "**版本：** 1.5.5（正式稳定版）"
assert_contains "Usage.md" '稳定 tag 为 `stable-v1.5.5`'
assert_contains "Usage.md" "git clone --branch stable-v1.5.5"
assert_contains "CHANGELOG.md" '正式 tag 为 `stable-v1.5.5`'
