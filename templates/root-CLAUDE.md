...
This project maintains agent startup guidance in `AGENTS.md`.

Claude Code must read `AGENTS.md` before starting project work and follow it as the primary guidance file.
